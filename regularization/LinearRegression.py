...
class LinearRegression:
    ...
    def linearFunction(self, data):
        #TODO: SAIDA DA FUNCAO LINEAR
        output = data.dot(self.weights)
        return output

    def logisticsFunction(self, data):
        #TODO: SAIDA DA FUNCAO LINEAR
        output = 1 / (1 + np.exp(-data.dot(self.weights)))
        if output >= 0.5:
            return 1
        else:
        	return 0
    ...
    def calculateError(self, data, target):
        ...
        output = self.logisticsFunction(data)
        error = output - target
        return error
...
if __name__ == '__main__':
        linReg = LinearRegression("/home/201719040800/Downloads/ia/regularization/income.csv",
                              "/home/201719040800/Downloads/ia/regularization/results",
